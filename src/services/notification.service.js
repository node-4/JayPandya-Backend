...
const Notify = require('../models/notification.model');
 ...
 const Addnotification = catchAsync(async (Notification) => {
 ...
 const getnotification = catchAsync(async (body) => {
 ...
 const updatenotification = catchAsync(async (id, body) => {
 ...
 const Deletenotification = catchAsync(async (id) => {
