 ...
 */
 const createProduct = catchAsync(async (body, files, seller) => {
  ...
  // const mainImage = files.filter((image) => image.fieldname === 'image_url');
  // const image_url = files.filter((image) => image.fieldname === 'image_url');
  ...
  //   image_url.push(image.secure_url);
